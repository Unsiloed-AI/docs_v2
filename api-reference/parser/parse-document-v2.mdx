...
description: "Create a parse job and receive a presigned URL to upload your document directly — no server relay, no file size constraints."
---
...
| Max file size | Limited by server upload | Up to 5 TB |
