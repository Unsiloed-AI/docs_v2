---
title: "Extract Data"
openapi: "/api-reference/openapi.json POST /v2/extract"
description: "Extract structured data from PDF documents using custom schemas with vision-language models"
---

## Overview

The `/v2/extract` endpoint extracts structured data from PDF documents using vision-language models. It supports multiple model tiers, optional bounding box citations, and intelligent page selection for large documents.
...
<ParamField body="model" type="string" default="gamma">
  ...
  **Recommended: `gamma`** (default) — best balance of accuracy, speed, and cost.
</ParamField>
