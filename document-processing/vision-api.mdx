...
## Getting Started with the /v2/extract Endpoint

Here are the steps to get started:

1. **Get an API Key** - [Sign up on Unsiloed AI](https://cal.com/aman-mishra-p0ry57/15min) to get API access
2. **Define a JSON Schema** - Specify the fields you want to extract. In the Unsiloed AI Platform, you can directly generate a JSON schema through the UI and export that schema as an endpoint to call the `/v2/extract` endpoint
