...
For simple fields like strings, numbers, and booleans, you must use the format `type: "string"` (not just `"string"`). These are the building blocks of your schema.
...
```json
{
  ...
  "required": ["invoice_number", "total_amount","quantity", "is_paid"],
